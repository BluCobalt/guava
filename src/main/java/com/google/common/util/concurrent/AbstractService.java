...
public abstract class AbstractService implements Service {
  ...
  protected final void notifyStarted() {
    monitor.enter();
    try {
      // We have to examine the com.google.common.util.concurrent.internal state of the snapshot here to properly handle the stop
      // while starting case.
  ...
  private static final class StateSnapshot {
    /**
     * The com.google.common.util.concurrent.internal state, which equals external state unless shutdownWhenStartupFinishes is true.
     */
    final State state;
