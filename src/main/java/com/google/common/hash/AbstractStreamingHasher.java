...
abstract class AbstractStreamingHasher extends AbstractHasher {
  ...
  /**
   * Constructor for use by subclasses. This hasher instance will process chunks of the specified
   * size, using an com.google.common.util.concurrent.internal buffer of {@code bufferSize} size, which must be a multiple of {@code
   * chunkSize}.
   *
   * @param chunkSize the number of bytes available per {@link #process(ByteBuffer)} invocation;
   *     must be at least 4
   * @param bufferSize the size of the com.google.common.util.concurrent.internal buffer. Must be a multiple of chunkSize
   */
