...
public final class CacheBuilder<K, V> {
  ...
  /**
   * Sets the minimum total size for the com.google.common.util.concurrent.internal hash tables. For example, if the initial capacity
  ...
  /**
   * Guides the allowed concurrency among update operations. Used as a hint for com.google.common.util.concurrent.internal sizing. The
   ...
   * once after loading completes). Much com.google.common.util.concurrent.internal cache management is performed at the segment
