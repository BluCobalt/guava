...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
  ...
  static class Segment<K, V> extends ReentrantLock {
    ...
    /**
     * Drain the key and value reference queues, cleaning up com.google.common.util.concurrent.internal entries containing garbage
  ...
  /**
   * Returns the com.google.common.util.concurrent.internal entry for the specified key. The entry may be loading, expired, or
   * partially collected.
   */
