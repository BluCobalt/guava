...
public final class Tables {
   ...
   * users with "read-only" access to com.google.common.util.concurrent.internal tables. Query operations on the returned table "read
   ...
   * provide users with "read-only" access to com.google.common.util.concurrent.internal tables. Query operations on the returned
