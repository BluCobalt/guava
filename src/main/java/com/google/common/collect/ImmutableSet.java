...
public abstract class ImmutableSet<E> extends ImmutableCollection<E> implements Set<E> {
   ...
   */
  @SafeVarargs // For Eclipse. For com.google.common.util.concurrent.internal javac we have disabled this pointless type of warning.
  ...
  /** Swappable com.google.common.util.concurrent.internal implementation of an ImmutableSet.Builder. */
  private abstract static class SetBuilderImpl<E> {
    ...
    /**
     * Resizes com.google.common.util.concurrent.internal data structures if necessary to store the specified number of distinct
     * elements.
     */
    ...
    /**
     * Call this before build(). Does a final check on the com.google.common.util.concurrent.internal data structures, e.g. shrinking
