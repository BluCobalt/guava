...
class MapMakerInternalMap<
   ...
   *
   * <p>This method is intended to only be used by the com.google.common.util.concurrent.internal implementation of {@link Interners},
  ...
  abstract static class Segment<
    ...
    /**
     * Unsafely sets the given index of this segment's com.google.common.util.concurrent.internal hash table to be the given entry.
     */
  ...
  /**
   * Returns the com.google.common.util.concurrent.internal entry for the specified key. The entry may be computing or partially
