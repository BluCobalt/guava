 ...
 * which is optimal, and <i>not</i> the size of the com.google.common.util.concurrent.internal hashtable, which could be much larger
 * than {@code size()}. Furthermore, this structure places significantly reduced load on the garbage
 * collector by only using a constant number of com.google.common.util.concurrent.internal objects.
 *
...
class CompactHashMap<K, V> extends AbstractMap<K, V> implements Serializable {
  ...
  /**
   * Resizes the com.google.common.util.concurrent.internal entries array to the specified capacity, which may be greater or less than
